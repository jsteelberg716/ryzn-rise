...
const faqs = [
  { q: "What's included in the 3-day free trial?", a: "Everything. Full access to the AI progression engine, muscle map, all workout programs, challenges, badges, shareable cards, recipes, articles, and all customization options. No limits. No credit card required." },
