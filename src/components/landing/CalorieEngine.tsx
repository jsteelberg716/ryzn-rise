...
import { FlaskConical, ArrowRight, Gauge, Dumbbell, Heart, Sparkles } from 'lucide-react';
...
const CalorieEngine = () => {
  ...
  return (
    <section
      ...
      className="relative bg-background py-24 md:py-28 px-6 section-glow overflow-hidden"
    >
      ...
      <div className="relative max-w-[900px] mx-auto">
        {/* Compact header — the whole thing collapses to "a button" */}
        <motion.div
        ...
        >
          <motion.span
            ...
            className="dmd-concave inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium tracking-widest uppercase text-accent-green"
          >
            <span className="w-1.5 h-1.5 rounded-full bg-accent-green animate-pulse" />
            The Calorie Engine · Patent Pending
          </motion.span>
          <motion.h2
            variants={fadeUpVariant}
          ...
          <motion.p
            variants={fadeUpVariant}
            className="mt-4 text-muted-foreground leading-relaxed mx-auto max-w-[560px]"
            style={{ fontSize: '1.0625rem' }}
          >
            Other apps guess from heart rate. RYZN measures the actual work you do —
            then proves it with physics.
          </motion.p>
        </motion.div>

        {/* Interactive proof + formula — slides in on scroll */}
        <motion.div
        ...
        >
              <div className="mt-10 dmd-convex rounded-[28px] p-5 sm:p-8 relative overflow-hidden">
                <div
                ...
                <div className="relative grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="dmd-convex rounded-[22px] p-6 md:p-8 relative overflow-hidden">
                    ...
                    <p className="relative text-sm text-muted-foreground mt-4 leading-relaxed">
                      Computed from mechanical work, muscular efficiency (η = 0.22), HR strain, and
                      EPOC afterburn.
                    </p>
                  </div>
                ...
                <div className="relative mt-8 p-5 md:p-6 rounded-2xl bg-white/[0.02] border border-primary/[0.08]">
                  ...
                  <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                    <div className="text-muted-foreground">
                      <code className="text-accent-green font-mono">η = 0.22</code> efficiency
                    </div>
                    <div className="text-muted-foreground">
                ...
                <div className="mt-7 flex justify-center">
                  <Link
                    to="/validation"
                    className="cta-validation inline-flex items-center gap-2 px-7 py-3.5 rounded-pill text-foreground font-bold text-[1rem]"
