...
const cards = [
  { gradient: 'linear-gradient(160deg, #1A1A26 0%, #2D1B69 100%)', rotate: -5, volume: '12,840 lbs', exercises: 8, sets: 24, prs: 3, workout: 'Push Day', date: 'March 28, 2026' },
  { gradient: 'linear-gradient(160deg, #0F1923 0%, #1A3A2A 100%)', rotate: 0, volume: '9,200 lbs', exercises: 6, sets: 18, prs: 1, workout: 'Pull Day', date: 'March 26, 2026' },
  { gradient: 'linear-gradient(160deg, #1A0A0F 0%, #3D1515 100%)', rotate: 5, volume: '15,600 lbs', exercises: 7, sets: 28, prs: 2, workout: 'Leg Day', date: 'March 24, 2026' },
];
    ...
    <section className="bg-bg-primary py-20 lg:py-32">
      <div className="max-w-[1200px] mx-auto px-6 flex flex-col lg:flex-row items-center gap-16">
        ...
        >
          ...
          <motion.div variants={fadeUpVariant} className="mt-6 space-y-2 text-text-secondary text-sm">
        ...
        >
          <div className="relative w-[280px] h-[420px] group">
            {cards.map((card, i) => (
              <motion.div
                key={i}
                className="absolute inset-0 rounded-2xl p-5 flex flex-col justify-between border border-primary/[0.15] overflow-hidden"
                style={{
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-2">
                    <div className="w-7 h-7 rounded-lg bg-primary/30 flex items-center justify-center text-foreground font-extrabold text-xs">R</div>
